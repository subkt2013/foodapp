...
<div class="bg-white py-6 sm:py-8 lg:py-12">
  <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
    <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-4 md:mb-8">Trusted by the best</h2>
  ...
  <div class="max-w-screen-xl px-4 md:px-8 mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 md:divide-x gap-8 md:gap-0">
      ...
      <div class="flex flex-col items-center md:p-4">
        <div class="text-indigo-500 text-xl sm:text-2xl md:text-3xl font-bold">200</div>
      ...
      <!-- stat - start -->
      <div class="flex flex-col items-center md:p-4">
        <div class="text-indigo-500 text-xl sm:text-2xl md:text-3xl font-bold">500+</div>
        <div class="text-sm sm:text-base font-semibold">People</div>
      </div>
  ...
  <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
    <div class="flex flex-col items-center bg-gray-100 rounded-lg p-4 sm:p-8">
      <div class="mb-4 sm:mb-8">
        <h2 class="text-indigo-500 text-xl sm:text-2xl lg:text-3xl font-bold text-center">Get the latest updates</h2>
...
<div class="bg-gray-900">
  <footer class="max-w-screen-2xl px-4 md:px-8 mx-auto">
    ...
    <div class="text-gray-400 text-sm text-center border-t border-gray-800 py-8">© 2021 - Present Flowrift. All rights reserved.</div>
  </footer>
</div>
<!-- footer - end -->
